...
if hash or DevBot(msg) or DevDavid(msg) or VIP_DeV(msg) then    
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevDavid(msg) or DevBot(msg) or VIP_DeV(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevDavid(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevDavid(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevDavid(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevDavid(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
local gmedia = database:scard(bot_id.."David:allM"..msg.chat_id_)  
if gmedia == 200 then
local liste = database:smembers(bot_id.."David:allM"..msg.chat_id_)
...
local gmria = database:scard(bot_id.."David:allM"..msg.chat_id_)  
...
database:set(bot_id.."David:Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
database:sadd(bot_id.."David:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."David:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:sadd(bot_id.."David:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."David:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:sadd(bot_id.."David:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."David:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:sadd(bot_id.."David:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."David:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:sadd(bot_id.."David:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."David:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:sadd(bot_id.."David:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."David:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
database:sadd(bot_id.."David:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."David:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
database:sadd(bot_id.."David:List:Cmd:Group:New"..msg.chat_id_,"تفع")
...
database:del(bot_id.."David:Sudo:Rd"..msg.chat_id_)
database:del(bot_id.."David:BasicConstructor:Rd"..msg.chat_id_)
database:del(bot_id.."David:Constructor:Rd"..msg.chat_id_)
database:del(bot_id.."David:Manager:Rd"..msg.chat_id_) 
database:del(bot_id.."David:Mod:Rd"..msg.chat_id_)
database:del(bot_id.."David:Special:Rd"..msg.chat_id_)
database:del(bot_id.."David:Memp:Rd"..msg.chat_id_)
end
...
function Function_David(extra, result, success)
if DevDavide(result.sender_user_id_)  then
...
if DevDavide(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."David:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."David:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."David:Constructor"..msg.chat_id_, result.sender_user_id_)
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, Function_David, nil)
end
...
if text == (database:get(bot_id.."David:Name:Bot") or "بلاك") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."David:Name:Bot") or "بلاك")
local namebot = {
...
os.execute('wget https://raw.githubusercontent.com/David/David/master/David.lua')
os.execute('wget https://raw.githubusercontent.com/David/David/master/start.lua')
dofile('David.lua')  
return false
end
if text == "راسلني" then
...
if DevDavid(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/David/files_David/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/David/files_David/master/files_David/"..file)
if res == 200 then
...
local Name_Bot = (database:get(bot_id.."David:Name:Bot") or "بلاك")
